...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppAsset.primary'
        db.add_column(u'AppDistribution_appasset', 'primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'App.primary_asset'
        db.delete_column(u'AppDistribution_app', 'primary_asset_id')


    def backwards(self, orm):
        # Deleting field 'AppAsset.primary'
        db.delete_column(u'AppDistribution_appasset', 'primary')

        # Adding field 'App.primary_asset'
        db.add_column(u'AppDistribution_app', 'primary_asset',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='app_primary', null=True, to=orm['AppDistribution.AppAsset'], blank=True),
                      keep_default=False)
