...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'AppDistribution_app', 'primary_asset',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='app_primary', null=True, to=orm['AppDistribution.AppAsset']),
                      keep_default=False)
    ...
    models = {
        u'AppDistribution.app': {
            ...
            'primary_asset': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'app_primary'", 'null': 'True', 'to': u"orm['AppDistribution.AppAsset']"}),
