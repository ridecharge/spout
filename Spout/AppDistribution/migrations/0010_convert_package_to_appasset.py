...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        apps = orm['AppDistribution.App'].objects.all()

        for app in apps:
           new_primary_asset = orm.AppAsset.objects.create(asset_file=app.package, notes=app.uuid)
           app.primary_asset = new_primary_asset
           app.save()
    ...
    def backwards(self, orm):
        ...
        for app in orm.App.objects.all():
            app.package = app.primary_asset.asset_file
            app.uuid = app.primary_asset.notes
            app.save()
