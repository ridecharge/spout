...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'App.creation_date'
        db.alter_column(u'AppDistribution_app', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'App.creation_date'
        raise RuntimeError("Cannot reverse this migration. 'App.creation_date' and its values cannot be restored.")
