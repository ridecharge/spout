...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppAsset.external_url'
        db.add_column(u'AppDistribution_appasset', 'external_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppAsset.external_url'
        db.delete_column(u'AppDistribution_appasset', 'external_url')
