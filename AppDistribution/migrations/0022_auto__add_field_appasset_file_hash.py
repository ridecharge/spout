...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppAsset.file_hash'
        db.add_column(u'AppDistribution_appasset', 'file_hash',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppAsset.file_hash'
        db.delete_column(u'AppDistribution_appasset', 'file_hash')
