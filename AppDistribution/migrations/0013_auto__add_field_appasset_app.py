...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppAsset.app'
        db.add_column(u'AppDistribution_appasset', 'app',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='app_assets', null=True, to=orm['AppDistribution.App']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppAsset.app'
        db.delete_column(u'AppDistribution_appasset', 'app_id')
