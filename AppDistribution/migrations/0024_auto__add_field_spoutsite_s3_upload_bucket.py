...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpoutSite.s3_upload_bucket'
        db.add_column(u'AppDistribution_spoutsite', 's3_upload_bucket',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpoutSite.s3_upload_bucket'
        db.delete_column(u'AppDistribution_spoutsite', 's3_upload_bucket')
