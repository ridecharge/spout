...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssetType.name'
        db.alter_column(u'AppDistribution_assettype', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Adding field 'AppAsset.asset_type'
        db.add_column(u'AppDistribution_appasset', 'asset_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['AppDistribution.AssetType'], null=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AssetType.name'
        raise RuntimeError("Cannot reverse this migration. 'AssetType.name' and its values cannot be restored.")
