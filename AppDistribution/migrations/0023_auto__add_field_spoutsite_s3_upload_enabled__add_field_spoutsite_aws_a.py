...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpoutSite.s3_upload_enabled'
        db.add_column(u'AppDistribution_spoutsite', 's3_upload_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SpoutSite.aws_access_key'
        db.add_column(u'AppDistribution_spoutsite', 'aws_access_key',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SpoutSite.aws_secret_key'
        db.add_column(u'AppDistribution_spoutsite', 'aws_secret_key',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpoutSite.s3_upload_enabled'
        db.delete_column(u'AppDistribution_spoutsite', 's3_upload_enabled')

        # Deleting field 'SpoutSite.aws_access_key'
        db.delete_column(u'AppDistribution_spoutsite', 'aws_access_key')

        # Deleting field 'SpoutSite.aws_secret_key'
        db.delete_column(u'AppDistribution_spoutsite', 'aws_secret_key')
