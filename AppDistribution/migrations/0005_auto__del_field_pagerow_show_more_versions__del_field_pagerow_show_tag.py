...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PageRow.show_more_versions'
        db.delete_column(u'AppDistribution_pagerow', 'show_more_versions')

        # Deleting field 'PageRow.show_tag'
        db.delete_column(u'AppDistribution_pagerow', 'show_tag')

        # Deleting field 'PageRow.show_age'
        db.delete_column(u'AppDistribution_pagerow', 'show_age')


    def backwards(self, orm):
        # Adding field 'PageRow.show_more_versions'
        db.add_column(u'AppDistribution_pagerow', 'show_more_versions',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PageRow.show_tag'
        db.add_column(u'AppDistribution_pagerow', 'show_tag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PageRow.show_age'
        db.add_column(u'AppDistribution_pagerow', 'show_age',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
